...
typedef enum STM32USBInterruptFlagBit STM32USBInterruptFlagBit;
enum STM32USBInterruptFlagBit {
	STM32_USB_INTERRUPT_FLAG_BIT_L1REQ = 7,
	STM32_USB_INTERRUPT_FLAG_BIT_ESOF,
	STM32_USB_INTERRUPT_FLAG_BIT_SOF,
	STM32_USB_INTERRUPT_FLAG_BIT_RESET,
	STM32_USB_INTERRUPT_FLAG_BIT_SUSP,
	STM32_USB_INTERRUPT_FLAG_BIT_WKUP,
	STM32_USB_INTERRUPT_FLAG_BIT_ERR,
	STM32_USB_INTERRUPT_FLAG_BIT_PMAOVR,
	STM32_USB_INTERRUPT_FLAG_BIT_CTR,
};
